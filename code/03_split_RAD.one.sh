...
#SBATCH -J spltONE
#SBATCH -e 03_split_RAD.one.%j.err
#SBATCH -o 03_split_RAD.one.%j.out
#SBATCH -c 20
#SBATCH -p high
...
# run script with
#	sbatch --mem MaxMemPerNode 03_split_RAD.one.sh
...
# set up directories
code_dir="/home/sejoslin/DS_history/code"
data_dir="/home/sejoslin/DS_history/data"

cd $data_dir

for i in BMAG044 #directory
do
barcode="TTAGGC,TGACCA,ACAGTG,GCCAAT" #barcodes
cd $i
