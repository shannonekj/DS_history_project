...
#SBATCH -J callGeno1
#SBATCH -e 19b_popGen_contempNe_rand30_minDepth_callGeno.err
#SBATCH -o 19b_popGen_contempNe_rand30_minDepth_callGeno.out
#SBATCH -c 20
#SBATCH -p high
...
out_dir="${data_dir}/ANGSD_calledGenotypes${cutoff}_depth"
