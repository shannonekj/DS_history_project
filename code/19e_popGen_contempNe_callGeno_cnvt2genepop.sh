...
#SBATCH -e 19e_popGen_contempNe_callGeno_cnvt2genepop.%j.err
#SBATCH -o 19e_popGen_contempNe_callGeno_cnvt2genepop.%j.out
#SBATCH -c 20
#SBATCH -p high
...
-SNP_pval 1e-6" >> Ht_${year}.callGeno.sh
		...
		echo "echo Now onto converting geno files to GENEPOP format \$(date)" >> Ht_${year}.callGeno.sh
		echo "perl /home/sejoslin/scripts/PopGenTools_3.00.pl GENEPOP \
-g Ht_${year}_callGeno.geno \
-n ${cutoff} \
-o Ht_${year}_callGeno.${cutoff}.genepop \
-p" >> Ht_${year}.callGeno.sh
