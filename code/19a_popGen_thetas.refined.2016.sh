...
#SBATCH -J theta
#SBATCH -e 19a_popGen_thetas.refined.2016.%j.err
#SBATCH -o 19a_popGen_thetas.refined.2016.%j.out
#SBATCH -c 20
#SBATCH -p high
...
echo "This file contains files for estimating theta (Watterson's and Pi) for in all archived samples (1993-2016). Analysis was restricted to sites that were not deemed paralogs with a Bonferroni Cutoff" >> README
echo "The files contained in this directory are:" >> README
echo "    year.list = a list of all the years to estimate thera for. Note: 1994, 2001, 2003, and 2005 were all excluded because we do not have individuals from these years." >> README
# by year
infile="year.list"
