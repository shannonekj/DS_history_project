...
#SBATCH -J SFSpara20
#SBATCH -e 15_getUnfoldSFS_wParalogs.%j.err
#SBATCH -o 15_getUnfoldSFS_wParalogs.%j.out
#SBATCH -c 20
...
module load angsd
angsd -bam ${pop}.rand20.bamlist -out ${pop}_wPara.rand20 -anc ../${ref} -GL 2 -doSaf 1 -minMapQ 10 -minQ 20
