...
# run script with
#       sbatch --mem MaxMemPerNode 04_rename.test.sh
...
do
        ...
        c3=$3 # barcode
        c4=$4 # unique ID
	echo mv ${c1}_${index}_GG${c3}TGCAGG_R1.fastq ${c4}_R1.fastq
	echo mv ${c1}_${index}_GG${c3}TGCAGG_R2.fastq ${c4}_R2.fastq
        head -2 ${c1}_${index}_GG${c3}TGCAGG_R1.fastq
	x=$(( $x + 1 ))
done
